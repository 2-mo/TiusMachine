...
namespace FindMianTri.Models
{
    public class ImageBlur
    {
        ...
        public ImageBlur(WriteableBitmap img)
        {
        ...
        public ImageBlur clone()
        {
            return new ImageBlur(this.image);
        }
        ...
        public int getPixelSat(int x, int y)
        {
            int[] i = RgbTranToHsl(getRComponent(x, y), getGComponent(x, y), getBComponent(x, y));
            return i[1];
        }

        public int getPixelLig(int x, int y)
        {
            int[] i = RgbTranToHsl(getRComponent(x, y), getGComponent(x, y), getBComponent(x, y));
            return i[2];
        }
        ...
        public static ImageBlur LoadImage(string path)
        {
    ...
    {
        ImageBlur process(ImageBlur imageIn);
    }
