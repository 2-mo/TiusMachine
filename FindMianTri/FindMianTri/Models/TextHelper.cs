...
namespace FindMianTri.Models
{
    class TextHelper
    {
        ...
        public string RandomEmoji()
        {
            ...
            double ranKey = ran.Next(1, 6);
            double ranKey2 = Math.Round(ranKey, 0);
            string k = ranKey2.ToString();
            switch (ranKey2)
            {
                case 1:
                    k = "🐱‍👤";
        ...
        /// 計算國曆當天對應的節氣 ，""表示不是節氣
        /// </summary>
        /// <returns>节气名称，""表示不是節氣</returns>
        public static string GetLunarHolDay(DateTime date1)
        {
            //*********************************************************************************
